const { body } = require("express-validator");
 ...
 const helpQuestionPostValidtion = [
   // body("id").isMongoId().withMessage(" helpQuestion id is not valid"),
    body("question").isAlpha({ ignore: " " }).withMessage("Question should be characters"),
    body("answer").optional().isAlpha({ ignore: " " }).withMessage("Answer should be characters"),

]
 const helpQuestionUpdateValidtion = [
   // body("id").isMongoId().withMessage("helpQuestion id is not valid "),
    body("question").isAlpha( { ignore: " " }).withMessage("Question name should be characters"),
    body("answer").optional().isAlpha( { ignore: " " }).withMessage("Answer name should be characters"),
]
